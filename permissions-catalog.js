...
const PERMISSIONS = [
  ...
  { key: 'mikrotik.vpn.manage', label: 'Quản lý user OpenVPN & xuất file cấu hình .ovpn trên MikroTik', group: 'MikroTik' },
];
...
const OPERATOR_EXCLUDED = new Set([
  ...
  'mikrotik.manage', 'mikrotik.rules.delete', 'mikrotik.vpn.manage',
]);

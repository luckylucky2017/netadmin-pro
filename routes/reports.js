...
async function fetchPeriod(sinceStr, untilStr) {
  ...
  const outboundForeign = await db.prepare(`
    SELECT vm_id, vm_name, remote_ip, remote_port, country, process_name, cmdline, cwd, remote_hostname, protocol, app_protocol, bytes_sent, bytes_received, first_seen, last_seen
